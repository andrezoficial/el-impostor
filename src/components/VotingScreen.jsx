    ...
    >
            ...
            {Array.from({ length: maxVotingRounds }).map((_, i) => (
              <motion.div
                ...
                style={{
                  ...
                  fontSize: 12,
                  fontWeight: 700,
                  background: i + 1 < votingRound
                    ? 'rgba(78,205,196,0.3)'
                    : i + 1 === votingRound
                    ? 'var(--primary)'
                    : 'rgba(255,255,255,0.08)',
                  border: i + 1 === votingRound
        ...
        <AnimatePresence>
          {isRunoff && (
            ...
            >
              ...
              <div>
                <span style={{ color: 'var(--warning)', fontWeight: 700, fontSize: 14 }}>
          ...
          return (
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                ...
                {isSelf && (
                  <span style={{ color: '#a7a9be', fontSize: 12 }}>(tú)</span>
                )}
              ...
              {isSelected && (
                <motion.div
                  initial={{ scale: 0 }}
                  animate={{ scale: 1 }}
                  style={{ color: 'var(--primary)', fontWeight: 700, fontSize: 20 }}
                >
                  ☠️
                </motion.div>
              )}
      ...
      <AnimatePresence>
        {selected !== null && !voted && (
          ...
          >
            <motion.button
              whileHover={{ scale: 1.04, boxShadow: '0 8px 25px rgba(233,69,96,0.45)' }}
              whileTap={{ scale: 0.96 }}
              onClick={confirmVote}
          ...
          >
            <div style={{
              ...
              <motion.div
                ...
                style={{ color: '#4ecdc4', fontSize: '20px', fontWeight: 'bold' }}
              >
                ✅ ¡Voto registrado!
              </motion.div>
