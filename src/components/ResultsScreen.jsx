    ...
    >
      ...
      >
        ...
        <motion.h2
          ...
          style={{ color: crewWins ? '#4ecdc4' : '#e94560' }}
        >
        ...
        <motion.div
          ...
          style={{ marginTop: '10px', color: '#a7a9be' }}
        >
      ...
      >
        ...
        {players.map((player, index) => (
          <motion.div
            ...
            style={{
              border: index === impostorIndex ? '2px solid #e94560' : '2px solid transparent',
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap' }}>
              ...
              {index === impostorIndex && (
                <motion.span
                  ...
                  className="badge badge-impostor"
                  style={{ marginLeft: '6px' }}
                >
                  <FaUserSecret style={{ marginRight: '4px' }} />
                  Impostor
                </motion.span>
              )}
      ...
      {/* Historial de rondas (colapsable) */}
      {hadMultipleRounds && (
        <motion.div
          initial={{ opacity: 0, y: 10 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          >
            <span>📋 Historial de rondas de votación ({allRoundsVotes.length})</span>
