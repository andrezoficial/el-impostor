  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.4 }} style={{ position: 'relative' }}>
      ...
      >
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.9 }} style={{ marginTop: '10px', color: '#a89a7d' }}>
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }} style={{ margin: '20px 0' }}>
        <h3 style={{ marginBottom: '15px', color: '#a89a7d' }}>{t('results.finalVoting')}</h3>
        {players.map((player, index) => (
          <motion.div
            ...
            style={{ border: allImpostorIndices.includes(index) ? '2px solid #a3311c' : '2px solid transparent', background: allImpostorIndices.includes(index) ? 'rgba(163, 49, 28,0.15)' : 'var(--card)' }}
          >
      ...
      {/* Palabra y pista */}
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.7 }} className="role-box" style={{ background: 'var(--card)', border: '2px solid #d9a544' }}>
